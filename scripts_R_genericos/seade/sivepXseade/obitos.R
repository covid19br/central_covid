...
seade <- read.csv2("https://raw.githubusercontent.com/seade-R/dados-covid-sp/d2c21f285dffa9913ad5bfad49b6ad4de8ebc956/data/dados_covid_sp.csv")[, c("datahora", "nome_drs", "obitos_novos")]
## Junta dados da grande sp
seade.drs1 <- aggregate(seade[grepl("Grande", seade$nome_drs),"obitos_novos"],
                        by = list(datahora=seade$datahora[grepl("Grande", seade$nome_drs)]), sum)
names(seade.drs1)[2] <- "obitos_novos"
...
## Funcao para ler dados do Observatorio, calcular indice do plano e juntar com dados SEADE
