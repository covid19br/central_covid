...
nowc <-
    ...
    labs(x = "Data do Óbito", y = "Número de Óbitos", colour = "Data do Boletim", title = "Evolução de Óbitos por Data de Óbito", caption = "Fonte: Boletins Epidemiológicos do Ministério da Saúde") +
