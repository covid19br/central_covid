...
write.zoo(R.median, paste0("Rt_DRS_median_", data, ".csv"), row.names = FALSE, index.name = "data")
R.max <- as.data.frame(do.call(merge, zoos.max))
R.max <- R.max[order(rownames(R.max), decreasing=TRUE),]
write.zoo(R.max, paste0("Rt_DRS_max_", data, ".csv"), row.names = FALSE, index.name = "data")
